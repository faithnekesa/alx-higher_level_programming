...
class TestRectangleStdout(unittest.TestCase):
    ...
    def capture_stdout(rect, method):
        ...
        Returns:
           Text printed to stdout by calling method on square
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
    ...
    def testStrMethodPrintWidth_height(self):
        r = Rectangle(4, 6)
...
class TestRectangleUpdateArgs(unittest.TestCase):
    ...
    def testUpdateArgsNoneIDand_more(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(None, 4, 5, 2)
    ...
    def testUpdateArgsInvalid_HightType(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
    ...
    def testUpdateArgs_xNegative(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "x must be >= 0"):
            r.update(89, 1, 2, -6)
    ...
    def testUpdateArgsWidthBefore_height(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
    ...
    def testUpdatAargsWidthBefore_y(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
...
class TestRectangleUpdateKwargs(unittest.TestCase):
    ...
    def testUpdateKwargsInvalidType_x(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            r.update(x="invalid")

    def testUpdateKwargsNegative_x(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "x must be >= 0"):
            r.update(x=-5)

    def testUpdateKwargsInvalidType_y(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            r.update(y="invalid")

    def testUpdateKwargsNegative_y(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "y must be >= 0"):
            r.update(y=-5)
...
class TestRectangleToDictionary(unittest.TestCase):
    ...
    def testDictionaryNoObjectChanges(self):
